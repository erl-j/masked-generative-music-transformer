...
import einops
from unet_blocks import First2D, Encoder2D, Decoder2D, Last2D, Center2D, First3D, Encoder3D, Decoder3D, Last3D, Center3D


class UNet2D(nn.Module):
    def __init__(self, in_channels, out_channels, conv_depths=(4,8,16,32,64,128,256)):
...
class UNet3D(nn.Module):
    def __init__(self, in_channels, out_channels, conv_depths=(4, 8, 16, 32, 64, 128)):
        assert len(conv_depths) > 2, 'conv_depths must have at least 3 members'
